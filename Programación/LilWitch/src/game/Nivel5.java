...
public class Nivel5 extends BasicGameState{
    ...
    public void init(GameContainer container, StateBasedGame game) throws SlickException {
        ...
        Wall oscuridad1_3 = new Wall(new float[]{1560, 860, 1590, 720, 1680, 720, 1680, 600, 1820, 600, 1820, 860});
        Wall oscuridad1_4 = new Wall(new float[]{1560, 100, 1560, 240, 1680, 240, 1680, 360, 1820, 360, 1820, 100});
        Wall oscuridad2_1 = new Wall(new float[]{});
        Wall oscuridad2_2 = new Wall(new float[]{});
        Wall oscuridad2_3 = new Wall(new float[]{});
        Wall oscuridad2_4 = new Wall(new float[]{});
        Wall oscuridad2_5 = new Wall(new float[]{});
        Wall oscuridad3_1 = new Wall(new float[]{});
        Wall oscuridad3_2 = new Wall(new float[]{});
        Wall oscuridad3_3 = new Wall(new float[]{});
        Wall oscuridad3_4 = new Wall(new float[]{});
        Wall oscuridad4_1 = new Wall(new float[]{});
        ...
        //walls1.add(oscuridad2_1);
        //walls1.add(oscuridad2_2);
        //walls1.add(oscuridad2_3);
        //walls1.add(oscuridad2_4);
        //walls1.add(oscuridad2_5);
        ...
        //walls1.add(oscuridad3_1);
        //walls1.add(oscuridad3_2);
        //walls1.add(oscuridad3_3);
        //walls1.add(oscuridad3_4);
        ArrayList<Puerta> puertas3 = new ArrayList();
        puertas3.add(p31);
        
        ArrayList<Wall> walls4 = new ArrayList<>();
        walls4.add(limites_4);
        //walls1.add(oscuridad4_1);
        //walls1.add(oscuridad4_2);
        //walls1.add(oscuridad4_3);
        //walls1.add(oscuridad4_4);
        //walls1.add(oscuridad4_5);
